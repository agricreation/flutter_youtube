                ...
                children: [
                  Container(
                    ...
                    child: Stack(
                      ...
                      children: [
                        CustomImageView(
                          imagePath: viewhierarchy1ItemModelObj?.image514,
                          height: 88.v,
                          width: 148.h,
                          alignment: Alignment.center,
                        ),
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              viewhierarchy1ItemModelObj.text514!,
                        ...
                        Column(
                          ...
                          children: [
                            SizedBox(
                              width: 137.h,
                              child: Text(
                                viewhierarchy1ItemModelObj.textCompilation!,
                                maxLines: 3,
                            ...
                            Text(
                              viewhierarchy1ItemModelObj.textOmarHanaIslamic!,
                              style: theme.textTheme.bodySmall,
                            ),
                            SizedBox(height: 3.v),
                            Text(
                              viewhierarchy1ItemModelObj.text55MViews!,
                              style: theme.textTheme.bodySmall,
                            ),
                          ],
                        ),
