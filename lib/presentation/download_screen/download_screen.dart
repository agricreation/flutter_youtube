import '../download_screen/widgets/viewhierarchy1_item_widget.dart';
          ...
          child: Consumer<DownloadProvider>(
            builder: (context, provider, child) {
              return ListView.separated(
                ...
                itemCount:
                    provider.downloadModelObj.viewhierarchy1ItemList.length,
                itemBuilder: (context, index) {
                  Viewhierarchy1ItemModel model =
                      provider.downloadModelObj.viewhierarchy1ItemList[index];
